...
<header>
    ...
    <div class="bannerText">
        <h1>I'M Nabila Wardhani</h1>
        <h3>Design &amp; Build Website Experiences</h3>
      </div>
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 noPadd slides-container" style="height:100%"> 
        <!--background slide show start-->
        <div class="slide"> 
          <img src="images/header-image/awalan.jpg" alt="awalan"> </div>
        <div class="slide"> 
          <img src="images/header-image/part.jpg" alt="part"> </div>
